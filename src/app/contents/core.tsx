            ...
            <div className="container py-8 m-auto">
                <div className="flex flex-col items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl">
                        {/* 카드 1 */}
                        <div className="bg-white/50 p-6 rounded-lg shadow-lg text-center transform transition duration-300 hover:-translate-y-2 hover:shadow-xl focus:-translate-y-2 focus:shadow-xl">
                        ...
                        {/* 카드 2 */}
                        <div
                            className="bg-white/50 p-6 rounded-lg shadow-lg text-center 
                transform transition duration-300 hover:-translate-y-2 hover:shadow-xl focus:-translate-y-2 focus:shadow-xl"
                        >
                            <div className="w-full h-40 mb-4 overflow-hidden rounded-lg bg-white/50">
                                <img
