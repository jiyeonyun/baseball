                ...
                {techs.map((tech, index) => (
                    ...
                    >
                        ...
                        <div className="absolute bottom-full mb-3 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-10">
                            <div className="px-3 py-1 bg-white dark:bg-gray-900 text-black dark:text-white text-xs rounded-full shadow-md border border-gray-300 dark:border-gray-700 whitespace-nowrap">
                                {tech.tooltip}
                            </div>
                        </div>
                    </motion.div>
